        ...
        <motion.div
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <div className='mt-4 flex items-center'>
                    ...
                    <label 
                        htmlFor='image'
                        className='cursor-pointer bg-gray-700 py-2 px-3 border border-gray-600 rounded-md shadow-md text-sm
                        leading-4 font-medium text-gray-300 hover:bg-gray-600 focus:ring-2 focus:ring-offset focus:ring-emerald-500'
