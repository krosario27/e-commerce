...
const Navbar = () => {
  ...
  return (
    ...
    <header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md z-40
            ...
            <nav className='flex flex-wrap items-center gap-5'>
                ...
                {user && (
                    ...
                    >
                        ...
                        <span
                            className='absolute -top-2 -left-3 bg-emerald-500 text-white rounded-full px-1 py-0.25 
