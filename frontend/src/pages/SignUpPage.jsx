...
import { UserPlus, Mail, Lock, User, ArrowRight, Loader, FileSpreadsheet } from 'lucide-react';
            ...
            <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
                <form onSubmit={handleSubmit} className='space-y-6'>
                    ...
                    <div>
                        ...
                        <div className='mt-1 relative rounded-md shadow-sm'>
                            <div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none'>
                                <Mail className='h5 w-5 text-gray-400' aria-hidden='true' />
                            </div>
                            <input
                                id="email"
                                type='email'
                    ...
                    <div>
                        ...
                        <div className='mt-1 relative rounded-md shadow-sm'>
                            ...
                            <input
                                ...
                                className='block w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-md shadow-sm
                                placeholder-gray-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm-txt-sm'
                                placeholder='••••••••'
                            />
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        font-medium text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none 
